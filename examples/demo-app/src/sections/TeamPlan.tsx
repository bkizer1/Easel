/**
 * Team plan card — intentionally DUPLICATED inline markup.
 *
 * One of three near-identical pricing cards (see StarterPlan, ProPlan) living
...
export function TeamPlan(): React.ReactElement {
  return (
    <article className="plan-card" data-easel-source="src/sections/TeamPlan.tsx:16:5">
      ...
      <button className="btn btn-secondary">Choose Team</button>
    </article>
  );
}
